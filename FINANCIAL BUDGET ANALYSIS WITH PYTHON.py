...
C:\Users\RAJESH KUMAR\Desktop\Python projects\FINANCIAL BUDGET ANALYSIS(Project)\FINANCIAL BUDGET ANALYSIS WITH PYTHON.csv


# In[8]:


df = pd.read_csv(r'C:\Users\RAJESH KUMAR\Desktop\Python projects\FINANCIAL BUDGET ANALYSIS(Project)\FINANCIAL BUDGET ANALYSIS WITH PYTHON.csv', encoding= 'unicode_escape')
...
Now plot this data into a donut plot to have a clear view of the distribution of funds among all the departments:
